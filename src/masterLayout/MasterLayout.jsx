...
{/* Update the Dashboard NavLink as well */}
<li>
  <NavLink
    to='/dashboard'
    ...
    <span>Dashboard</span>
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                ...
                <li>
                  <NavLink to='/add-category' className={(navData) => navData.isActive ? "active-page" : ""}>
                    <i className='ri-circle-fill circle-icon text-success-main w-auto' />
                    Add Category
                  </NavLink>
                </li>
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <NavLink to='/service' className={(navData) => navData.isActive ? "active-page" : ""}>
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />
                    Service List
                  </NavLink>
                </li>
                <li>
                  <NavLink to='/add-service' className={(navData) => navData.isActive ? "active-page" : ""}>
                    <i className='ri-circle-fill circle-icon text-success-main w-auto' />
                    Add Service
                  </NavLink>
                </li>
            ...
            {/* Customer  */}
            <li>
              <NavLink to='/customer' className={(navData) => navData.isActive ? "active-page" : ""}>
              ...
              <NavLink
                ...
                className={(navData) => {
                  ...
                  const here =
                    ...
                    p === "/coupons" ||
                    p === "/add-coupon" ||
                    /^\/(edit|view)-coupon\//.test(p);
                  return here ? "active-page" : "";
                }}
              >
              ...
              <NavLink
                ...
                className={(navData) => {
                  ...
                  const here =
                    ...
                    p === "/occupations" ||
                    p === "/add-occupation" ||
                    /^\/(edit|view)-occupation\//.test(p);
                  return here ? "active-page" : "";
                }}
              >
                <Icon icon='mdi:briefcase-account-outline' className='menu-icon' />
                <span>Occupations</span>
              </NavLink>
            </li>

            <li>
              <NavLink to='/orders' className={(navData) => navData.isActive ? "active-page" : ""}>
            ...
            <li>
              <NavLink to='/points' className={(navData) => navData.isActive ? "active-page" : ""}>
